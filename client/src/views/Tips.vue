<template>
    <div class="container text-center">
		<h1 class="display-1 my-5">Tipy a triky</h1>
		<form>
...
async function search() {
	let response = await getBlogPosts({nameFilter: form.value.nameFilter, order: "created_at", ascending: false, page: currentPage.value, pageSize: pageSize, tagFilter:'tips'});
